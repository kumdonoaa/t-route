...
def main_v04(argv):    
    ...
    for run_set_iterator, run in enumerate(run_sets):
        ...
        if network == type(HYFeaturesNetwork):
            #includes headwater interpolation
            run_results = nwm_route(
                ...
                firstRun,
                logFileName,
                pseudo_headwater_dict = network.pseudo_headwater_dict,
                giuh_node=giuh_node
            )
        else:
            run_results = nwm_route(
...
def nwm_route(
    ...
    results = compute_nhd_routing_v02(
        ...
        pseudo_headwater_dict = pseudo_headwater_dict,
        giuh_node = giuh_node
    )
